...
// Результат.ПутьК1cedtcli — путь к 1cedtcli (пустая строка, если файл не найден)
...
4. **Определение пути к 1cedtcli** — в каталоге установки ищется исполняемый файл `1cedtcli`. Если найден — возвращается полный путь, если нет — пустая строка.
